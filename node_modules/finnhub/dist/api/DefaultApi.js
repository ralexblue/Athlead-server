...
var _Covid = _interopRequireDefault(require("../model/Covid19"));
...
var _Resistance = _interopRequireDefault(require("../model/Resistance"));
...
var _TechnicalIndicators = _interopRequireDefault(require("../model/TechnicalIndicators"));
...
var DefaultApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(DefaultApi, [{
    ...
    key: "cryptoCandles",
    value: function cryptoCandles(symbol, resolution, from, to, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'symbol' is set
    ...
    key: "forexCandles",
    value: function forexCandles(symbol, resolution, from, to, opts, callback) {
      opts = opts || {};
      var postBody = null; // verify the required parameter 'symbol' is set
    ...
    key: "stockTick",
    value: function stockTick(symbol, _date, callback) {
      var postBody = null; // verify the required parameter 'symbol' is set
    ...
    value: function supportResistance(symbol, resolution, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _Resistance["default"];
    ...
    value: function technicalIndicator(symbol, resolution, from, to, indicator, opts, callback) {
      ...
      var contentTypes = [];
      var accepts = ['application/json'];
      var returnType = _TechnicalIndicators["default"];
